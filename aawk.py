...
#long command -> awk -F"date=" '{print $2}' b.log | cut -f1 -d" "

#short command -> aawk date= " " file


if len(sys.argv) != 4:
	print("""

Error with your command. Help is displayed.
...
""")
	...
	command='awk -F"'+field+'"'+" '{print $2}' "+file+' | cut -f1 -d"'+divider+'"'
